...
function displayStaff() {
    ...
    for (let i = 0; i < staffTable.length; i++) {

        rows += `
        <tr>
            <td>${staffTable[i][0]}</td>
            <td>${staffTable[i][1]}</td>
            <td>${staffTable[i][5]}</td>
        </tr>
        `;
    }
...
// RUn function when the fully code is loaded.
